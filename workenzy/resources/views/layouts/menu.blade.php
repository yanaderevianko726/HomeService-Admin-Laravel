...
@can('eProviders.index')
    <li class="nav-item has-treeview {{ (Request::is('eProvider*') || Request::is('requestedEProviders*') || Request::is('galleries*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('countries*') || Request::is('availabilityHours*') ) && !Request::is('eProviderPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('eProvider*') || Request::is('requestedEProviders*') || Request::is('galleries*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('countries*') || Request::is('availabilityHours*')) && !Request::is('eProviderPayouts*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            ...
            <!--@can('countries.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('countries*') ? 'active' : '' }}" href="{!! route('countries.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-flag"></i>@endif<p>{{trans('lang.countries')}}</p></a>
                </li>
            @endcan-->
        </ul>
    </li>
