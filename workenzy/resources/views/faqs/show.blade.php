        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! route('faqs.create') !!}"><i class="fas fa-plus mr-2"></i>{{trans('lang.faq_create')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                ...
                <!-- Back Field -->
                    <div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
                        <a href="{!! route('faqs.index') !!}" class="btn btn-default"><i class="fas fa-undo"></i> {{trans('lang.back')}}</a>
                    </div>
                </div>
