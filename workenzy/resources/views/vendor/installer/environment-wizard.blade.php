...
@section('container')
    <div class="tabs tabs-full">
        ...
        <input id="tab1" type="radio" name="tabs" class="tab-input" checked/> <label for="tab1" class="tab-label">
            <i class="fas fa-cog fa-2x fa-fw" aria-hidden="true"></i> <br/>
        ...
        <input id="tab2" type="radio" name="tabs" class="tab-input"/> <label for="tab2" class="tab-label">
            <i class="fas fa-database fa-2x fa-fw" aria-hidden="true"></i> <br/>
        ...
        <input id="tab3" type="radio" name="tabs" class="tab-input"/> <label for="tab3" class="tab-label">
            <i class="fas fa-cogs fa-2x fa-fw" aria-hidden="true"></i> <br/>
            ...
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    ...
                    @if ($errors->has('purchase_code'))
                        <span class="error-block"> <i class="fas fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            ...
                            <label for="broadcast_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.broadcasting_label') }}
                                <sup>
                                    <a href="https://laravel.com/docs/5.4/broadcasting" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        <i class="fas fa-info-circle fa-fw" aria-hidden="true"></i> <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>
                                    </a>
                                </sup>
                            </label>
