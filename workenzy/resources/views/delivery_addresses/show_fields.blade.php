...
<!-- Address Field -->
<div class="form-group row col-6">
    {!! Form::label('address', 'Address:', ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
    <div class="col-md-9">
...
<!-- Latitude Field -->
<div class="form-group row col-6">
    {!! Form::label('latitude', 'Latitude:', ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
    <div class="col-md-9">
...
<!-- Longitude Field -->
<div class="form-group row col-6">
    {!! Form::label('longitude', 'Longitude:', ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
    <div class="col-md-9">
...
<!-- Is Default Field -->
<div class="form-group row col-6">
    {!! Form::label('is_default', 'Is Default:', ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
    <div class="col-md-9">
